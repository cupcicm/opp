...
func TestPrStory(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			expectedBody:   "my body\n\n[Story](https://my.base.url/browse/ABC-123)",
		},
		{
		...
		},
		{
			...
			expectedBody:   "[Story](https://my.base.url/browse/ABC-123)",
		},
		{
